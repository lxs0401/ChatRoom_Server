...
public class UserModel {
     ...
     * @throws SQLException
     */
    public UserInfo createUser(String passwd, String nick, int avatar,byte[] identityKey,byte[] signedPreKey,byte[] signedPreKeySig,int reistrationId,byte[][] preKeys) throws SQLException {
        ...
        db.insertSecurityKeys(res,reistrationId,identityKey,signedPreKey,signedPreKeySig,reistrationId,preKeys);
